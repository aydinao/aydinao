...
My work centres on ROS 2 — navigation, SLAM, and multi-agent systems — and the full-stack software around real systems, from APIs and message queues up to dashboards and cloud. More recently I've been working further down the stack, into embedded Linux and the driver layer, bringing up robot hardware from scratch.
...
- **Backend & full-stack** — Python, FastAPI, MQTT, PostgreSQL, Docker, Azure IoT, CI; web roots in JS/React
...
- **[picar-4wd](https://github.com/aydinao/picar-4wd-ros2-jazzy)** — bringing up the SunFounder PiCar-4WD on Ubuntu 24.04 with ROS 2 Jazzy: embedded Linux, I2C, and the undocumented HAT reset fix.
